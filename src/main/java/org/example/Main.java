...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("by name 1: " + personRepo.getPersonByName("Anna").get());

        System.out.println("by name 3: " + personRepo.getPersonByName("Ana").orElseThrow(() -> new NullPointerException("No data!")));
